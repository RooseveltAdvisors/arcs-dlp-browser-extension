module.exports = [
  ...
  },
  {
    setting: "rpcEndpoint",
    pattern:
      /\bhttps:\/\/(ethereum-mainnet|polygon-mainnet|bsc-mainnet)\.core\.Arcs\.com\/[a-zA-Z0-9]{32}\b/g,
    placeholder: "**RPC_ENDPOINT**",
  },
  {
    setting: "rpcEndpoint",
  ...
  },
  {
    setting: "rpcEndpoint",
    pattern:
      /\b(wss):\/\/(ethereum-mainnet|polygon-mainnet|bsc-mainnet)\.core\.Arcs\.com\/ws\/[a-zA-Z0-9]{32}\b/g,
    placeholder: "**RPC_ENDPOINT**",
  },
  {
    setting: "rpcEndpoint",
